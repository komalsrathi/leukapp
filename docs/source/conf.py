...
# sphinx-quickstart on Fri Nov 20 12:23:10 2015.
#
...
latex_documents = [
  (master_doc, 'leukapp.tex', 'leukapp Documentation',
   'Juan Medina', 'manual'),
]
...
man_pages = [
    (master_doc, 'leukapp', 'leukapp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'leukapp', 'leukapp Documentation',
   author, 'leukapp', 'One line description of project.',
   'Miscellaneous'),
]
