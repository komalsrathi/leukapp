    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text='This is for your future self.', max_length=140, verbose_name='description')),
                ...
                ('result', models.FileField(blank=True, upload_to='leukform/results/%Y/%m', verbose_name='sumbission result')),
                ('summary', models.TextField(blank=True, verbose_name='summary')),
                ('mock', models.BooleanField(default=False, help_text='if True, records will not be saved.', verbose_name='test leukform')),
