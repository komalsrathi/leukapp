...
class Specimen(LeukappModel):
    ...
    """
    Source of the tissue/specimen. See :data:`~.constants.SOURCE` for
    available choices.
    """
    ...
    """
    Count of the total number of :class:`~leukapp.apps.aliquots.models.Aliquot`
    ...
    """
    Internal ID used to describe the :class:`Specimen` object.
    ...
    * ``T1`` indicates that the current :class:`Specimen` is the first
    ...
    If there was a mistake a new :class:`Specimen` instance must be created.
    """
